...
class Document(TimestampMixin, Base):
    ...
    processing_status: Mapped[Optional[str]] = mapped_column(String(64))
...
class Chunk(TimestampMixin, Base):
    ...
    section_title: Mapped[Optional[str]] = mapped_column(String(1024))
    summary: Mapped[Optional[str]] = mapped_column(Text)
    keywords: Mapped[list[str]] = mapped_column(JSON, default=list)
    synthetic_questions: Mapped[list[str]] = mapped_column(JSON, default=list)
